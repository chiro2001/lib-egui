...
public class Shader {
    ...
    static {
        try {
            VS_SRC_150 = Resources.toString(ClassLoader.getSystemResource("shaders/vs_150.vert"), Charset.defaultCharset());
            FS_SRC_150 = Resources.toString(ClassLoader.getSystemResource("shaders/fs_150.frag"), Charset.defaultCharset());
            VS_SRC = Resources.toString(ClassLoader.getSystemResource("shaders/vs.vert"), Charset.defaultCharset());
            FS_SRC = Resources.toString(ClassLoader.getSystemResource("shaders/fs.frag"), Charset.defaultCharset());
        } catch (IOException e) {
